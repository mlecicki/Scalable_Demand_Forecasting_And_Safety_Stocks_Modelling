...
Above plot confirms negative BIAS in Netherlands and Denmark and presence of positive BIAS in UK over majority of test horizon. <br/>
...
1. tracking signal - arithmetic sum of errors divided by mean absolute deviation (error); this is approach described in APICS CPIM; acceptable value depends on decision-makers.
...
We'll re-do modelling only for countries with BIAS.
...
```
Let's again visualized models for the three countries. Again, we'll do that only for test horizon to improve readability.<br/>
