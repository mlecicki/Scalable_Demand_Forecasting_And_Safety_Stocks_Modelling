...
We can however create custom metrics with a help of parsley library which provides a standard template for this. To present this functionality, we'll build a few simple BIAS-oriented metrics and some other demand forecasting accuracy-oriented metrics.
